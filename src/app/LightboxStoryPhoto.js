...
const LightboxStoryPhoto = ({
  ...
  return (
    ...
    >
      ...
      <GalleryLightboxDetailsContainer backgroundColor={backgroundColor}>
        <ScrollableContainer>
          {parentStoryQuestion ? (
            <GalleryLightboxTitleContainer>
              ...
              <GalleryLightboxSubtitleContainer color={fontColor}>
                <SubArrow width="22px" height="22px" viewBox="0 0 464 464">
                  <SubArrowPath
                    fill="rgba(255, 197, 78, 0.4)"
          ...
          {creator && (
            <GalleryLightBoxCreatorContainer>
              ...
              >
                <GalleryLightboxUploaderName color={fontColor}>
                  {creator.name}
                </GalleryLightboxUploaderName>
                <GalleryLightboxUploaderDate color={fontColor}>
                  {creator.title}
          ...
          <BottomShadow color={backgroundColor} />
        </ScrollableContainer>
