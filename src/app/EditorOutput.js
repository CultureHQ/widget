...
const tagStylesPerOrg = (organizationName) => {
...
const badgeStylesPerOrg = (organizationName) => {
  if (organizationName === "Target") {
    return {
              ...
              && entity.data.name ? (
                <span
                  style={{
                    ...
                    ...badgeStylesPerOrg(organizationName)
                  }}
                ...
                >
                  ...
                  <span
                    style={{
                      ...
                      ...(darkTags ? darkTag : tag),
                      ...tagStylesPerOrg(organizationName)
                    }}
                    >
                    {entity.data.name}
                  </span>
